  ...
  return (
    <div>
        <div className='space-y-2'>
            <h1 className='text-3xl font-semibold'>Navigating the digital landscape for success</h1>
            <img src={heroSection}alt='logo'/>
        </div>
        <img className='hidden' src={heroSection} 
        alt="logo" />
        <h3 className='text-xs mb-2'>Our digital marketing agency helps businesses grow and succeed online through a range of services including SEO, PPC, social media marketing, and content creation.</h3>
